package com.example.projekatovo.filters;
        ...
        try {
            ...
            if (userEmail != null && authentication == null) {
                ...
                if (refreshToken.isPresent()) {
                    //(User) je mozda greska
                    isRefreshTokenValid = jwtService.isTokenValid(refreshToken.get().getRefreshToken(), (User) userDetails);
                }
